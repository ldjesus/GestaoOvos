    ...
    public partial class Primeiramigracao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusEntrega", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusPgto", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeId = table.Column<int>(type: "int", nullable: true),
                    Qtd = table.Column<int>(type: "int", nullable: false),
                    Total = table.Column<double>(type: "float", nullable: false),
                    VendedorId = table.Column<int>(type: "int", nullable: false),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    ProdutoId = table.Column<int>(type: "int", nullable: false),
                    StatusPgtoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendas_FormaPagamento_FormaPagamentoId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.QuantidadeId,
                        principalTable: "Quantidade",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vendas_StatusEntrega_StatusEntregaId",
                        column: x => x.StatusEntregaId,
                        principalTable: "StatusEntrega",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendas_StatusPgto_StatusPgtoId",
                        column: x => x.StatusPgtoId,
                        principalTable: "StatusPgto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendas_StatusEntregaId",
                table: "Vendas",
                column: "StatusEntregaId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendas_StatusPgtoId",
                table: "Vendas",
                column: "StatusPgtoId");
